...
//    @DeleteMapping("/deleteAnswer/{questionDetailId}/{answerId}")
//    public Answer deleteAnswer(@PathVariable("questionDetailId")String qId,
//    		@PathVariable("answerId") String aId)
//    {
//    	return paperService.deleteAnswer(qId,aId);
//    }
